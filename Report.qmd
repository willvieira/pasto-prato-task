...
This document is a dynamic report generated with R and Quarto. The source code for this report is hosted on [GitHub](https://github.com/willvieira/doPastoAoPrato_exercise) and can be generated in the `Code` hyperlink at the top right of this page.
...
Figure 1. Distribution of meat suppliers by Brazilian states.
